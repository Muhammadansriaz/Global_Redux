...
const Header = () => {
  let [new_image, set_newimage] = useState();
  // let url  = URL.createObjectURL(new_image)
                ...
                >
                  <div className="modal-content">
                      ...
                      <form>
                        <div className="form-group">
                          <input
                            ref={new_image}
                            onChange={(ev) => {
                              set_newimage(ev.target.files[0]);
                            }}
                            type="file"
                    ...
                    <div className="modal-footer">
                      ...
                      <button onClick = {()=>dispatch(addProducts({name :new_name,description :new_des,image :URL.createObjectURL(new_image)}))}
                        type="button"
                        data-dismiss="modal"
